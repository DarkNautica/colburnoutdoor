...
const featured = {
  ...
  image: "/images/sprinkler-hero.png",
};
    ...
    <main id="site-root" ref={root}>
      ...
      <section className="services-section" id="services" aria-labelledby="services-title">
        ...
        <article className="service-featured" data-reveal>
          ...
          <div className="service-featured-media">
            <img src={featured.image} alt="A working sprinkler head watering a maintained lawn" loading="lazy" />
          </div>
        </article>
      ...
      <section className="property-section" id="property" aria-labelledby="property-title">
        <div className="property-visual">
          <img src="/images/hero-yard.png" alt="A neat, maintained lawn and home exterior" loading="lazy" />
